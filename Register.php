...
echo "<p></p>";
echo "<div class=\"form-group\" style=\" margin: auto;  width: 20%;\">";
echo     "<input type=\"text\" class=\"form-control\" placeholder=\"Email\" id=\"Email\">";
echo "</div>";
echo "<p></p>";
...
echo     "<button class=\"btn btn-secondary my-2 my-sm-0\" type=\"button\" onclick=\"Register()\">Login</button>";
echo "</div>";
echo "</body>";
echo "</html>";
